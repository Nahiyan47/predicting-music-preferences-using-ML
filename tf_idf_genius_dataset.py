...
# Convert text data (lyrics) to numerical format using TF-IDF vectorization
tfidf = TfidfVectorizer(max_features=1000)  # You can adjust max_features as needed
X_train_tfidf = tfidf.fit_transform(X_train["lyrics"].astype(str))
X_test_tfidf = tfidf.transform(X_test["lyrics"].astype(str))
